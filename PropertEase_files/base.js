...
(function (root, G) {
  ...
  "account--app-notifications--link-visits--description": function(d) { return "Get notified when a visitor who provided an email address views your link."; },
  ...
  "account--deletion-request-modal-owner-text": function(d) { return "You’re the owner of #[workspaces].#[br] #[link:Learn how to transfer ownership] of your workspaces instead of deleting them. #[br]#[br]"; },
  ...
  "presentation-views--tabs--analytics-links": function(d) { return "Analytics links"; },
  ...
  "presentation-views--table--visitor-email--unknown": function(d) { return "Unknown via " + d.browser; },
  ...
  "presentation-views--analytics-links-list--title": function(d) { return "Analytics link activity"; },
  ...
  "presentation-views--analytics-links-list--subtitle": function(d) { return "Keep track of visits from analytics links you’ve shared. When engagement analytics are enabled for a link, you can also see slide engagement and return visits."; },
  ...
  "app-search-modal--results--empty": function(d) { return "We couldn’t find any results matching your keywords. Try searching again with different terms."; },
  ...
  "auth--login-error--duplicate-email": function(d) { return "There was a problem with this email address. Contact customer support with your email address for help."; },
  ...
  "billing--pro-page--manage--cancel-subscription--continue": function(d) { return "Continue to cancel"; },
  ...
  "billing--pro-page--manage--cancel-subscription--deterrent--description-start": function(d) { return "If you cancel your subscription, you won’t be able to invite more than 5 members"; },
  "billing--pro-page--manage--cancel-subscription--deterrent--description-end": function(d) { return ", and you’ll no longer have access to these features:"; },
  "billing--pro-page--manage--cancel-subscription--deterrent--description-custom-variables": function(d) { return ", any existing custom variables will be permanently removed"; },
  "billing--pro-page--manage--cancel-subscription--feature--analytics-links": function(d) { return "Analytics links"; },
  "billing--pro-page--manage--cancel-subscription--feature--embeds": function(d) { return "Interactive embeds"; },
  "billing--pro-page--manage--cancel-subscription--feature--roles": function(d) { return "Workspace roles"; },
  "billing--pro-page--manage--cancel-subscription--feature--fonts": function(d) { return "Custom fonts"; },
  "billing--pro-page--manage--cancel-subscription--feature--variables": function(d) { return "Custom variables"; },
  "billing--pro-page--manage--cancel-subscription--feature--shared-private-folders": function(d) { return "Sharing private folders"; },
  "billing--pro-page--manage--cancel-subscription--feature--version-history": function(d) { return "Version history"; },
  "billing--pro-page--manage--cancel-subscription--feature--video-upload": function(d) { return "Uploading videos"; },
  "billing--pro-page--manage--cancel-subscription--feature--sharing-links": function(d) { return "Unbranded sharing links"; },
  "billing--pro-page--manage--cancel-subscription--feature--upload-files": function(d) { return "Uploading files over 5MB"; },
  "billing--pro-page--manage--cancel-subscription--feature--ppt-export": function(d) { return "PPT exports"; },
  "billing--pro-page--manage--cancel-subscription--feature--unbranded-pdf-exports": function(d) { return "Unbranded PDF exports"; },
  "billing--pro-page--manage--cancel-subscription--feature--collections": function(d) { return "Library collections"; },
  "billing--pro-page--manage--cancel-subscription--pay--title": function(d) { return "What happens when you cancel?"; },
  "billing--pro-page--manage--cancel-subscription--pay--description": function(d) { return "You’ll be charged only for seats added in this billing cycle and for seats added until the end of your subscription."; },
  "billing--pro-page--manage--cancel-subscription--end--description-new": function(d) { return "You have access to Pitch " + select(d.business, { true: "Business", other: "Pro" }) + " until #[cycle], which is when your billing cycle ends."; },
  "billing--pro-page--manage--cancel-subscription--analytics--description": function(d) { return "When your subscription is downgraded to the Free plan, all Analytics Links will be disabled and not accessible to visitors."; },
  ...
  "billing--plan--editors-and-additional": function(d) { return "Includes #[editors]. Extra editors: #[extra-editor-price]"; },
  "billing--paid-plan--editors": function(d) { return d.count + " editors"; },
  "billing--premium-plan--editors-and-additional--info": function(d) { return "Editors are paid roles, including the owner, admins, and creators"; },
  ...
  "billing--pro-2024-plan--variables": function(d) { return "Custom variables"; },
  ...
  "billing--downgrade-modal-v2--features-list--analytics": function(d) { return "Unlimited analytics links"; },
  ...
  "billing--downgrade-modal-v2--disabled-links": function(d) { return "If your workspace has more than 25 active analytics links, all will be disabled."; },
  ...
  "billing--feature--variables": function(d) { return "Custom variables"; },
  "billing--feature--variables--tooltip": function(d) { return "Use variables to keep content like dates and names aligned throughout your deck"; },
  ...
  "billing--feature--analytics-links": function(d) { return "Analytics links"; },
  "billing--feature--analytics-links--tooltip-2024": function(d) { return "Send decks with analytics links to measure viewer engagement. Optional passcodes ensure security"; },
  ...
  "billing--feature-section--community": function(d) { return "Community access"; },
  "billing--feature-section--community--tooltip": function(d) { return "Get access to Pitch's Slack community to hear about the latest updates and meet other Pitch users"; },
  ...
  "billing--upsell--modal--dashboard--insights--page--subtitle": function(d) { return "Understand the impact of every deck — from sales proposals to internal company updates."; },
  "billing--upsell--modal--dashboard--insights--page--analytics--title": function(d) { return "Track interest with analytics links"; },
  ...
  "billing--upsell--modal--contextual--custom--links--title": function(d) { return "Analytics links."; },
  ...
  "billing--upsell--modal--contextual--custom--links--feature--link--title": function(d) { return "Analytics links"; },
  ...
  "billing--upsell--modal--contextual--custom-variables--title": function(d) { return "Create custom variables."; },
  "billing--upsell--modal--contextual--custom-variables--subtitle": function(d) { return "Add variables for dates, company information, or client data to your templates and presentations."; },
  "billing--upsell--modal--contextual--custom-variables--feature-link-title": function(d) { return "Custom variables"; },
  "billing--upsell--modal--contextual--custom-variables--feature-link-tooltip": function(d) { return "Add variables for dates, company information, or client data to your templates and presentations."; },
  ...
  "billing--faq--question--members--presentation-analytics--q": function(d) { return "What are presentation analytics and analytics links?"; },
  "billing--faq--question--members--presentation-analytics--a": function(d) { return "Analytics links let you track slide views, time spent on slides, and other data when recipients open a link. They also let you set a passcode for your link. They’re what give you access to presentation analytics for your deck.#[line-br:Presentation analytics are a feature of analytics links. For basic links, you will see general statistics like view counts and a visitor log. For analytics links, the data is more detailed and robust.]#[line-br:Basic sharing links let you share a presentation with rich animations and videos that’s always up to date, but don’t include analytics about your visitors’ activity.]"; },
  ...
  "billing--free-trial--greeting": function(d) { return "Try Pro for " + d.length + " days!"; },
  "billing--free-trial--cta": function(d) { return "Discover Pitch Pro"; },
  "billing--free-trial--expiry": function(d) { return "Trial ends " + select(d.days, { "0": "today", "1": "tomorrow", other: "in # days" }); },
  ...
  "billing--upsell--modal--free-trial--info--tooltip": function(d) { return "Your entire workspace will be#[br]upgraded for " + plural(d.length, 0, en, { "0": "today", "1": number(d.length, "length") + " day", other: number(d.length, "length") + " days" }) + ".#[br]All members will be able to#[br]access Pro features."; },
  "billing--upsell--modal--free-trial--no--card": function(d) { return "No credit card required"; },
  "billing--upsell--modal--free-trial--button": function(d) { return "Start " + d.length + "-day free trial"; },
  "billing--upsell--modal--free-trial--success": function(d) { return "It’s official! Your " + d.length + "-day free trial starts now."; },
  ...
  "dashboard--folder-deletion-dialog--comment": function(d) { return "This will delete the folder and all its subfolders. Deleted presentations are available in “Recently deleted” for 10 days, before they are removed automatically."; },
  ...
  "common--alert--with-invites--link-copied--description": function(d) { return "Workpsace members and invited collaborators can use it."; },
  ...
  "common--alert--dashboard-document-duplicated--show-in-folder": function(d) { return "Show in folder"; },
  ...
  "common--alert--document-restored--show-in-folder": function(d) { return "Show in folder"; },
  ...
  "common--alert--managed-links--edit-failure--quota-reached-title": function(d) { return "No more analytics links available"; },
  ...
  "importer-ppt-modal--success--body": function(d) { return "Your imported presentation is now in your " + d.folder + " folder."; },
  ...
  "importer--toast--title": function(d) { return "Your imported presentation is now in your " + d.folderName + " folder."; },
  ...
  "dashboard--header--subtitle--workspace-folder": function(d) { return "Create presentations that everyone on your team can see"; },
  "dashboard--header--subtitle--trash-page": function(d) { return "Presentations and templates that appear here will be permanently deleted after 10 days."; },
  "dashboard--collapsible--folders": function(d) { return "Folders"; },
  "dashboard--collapsible--deal-rooms": function(d) { return "Deal rooms"; },
  ...
  "dashboard--rename-modal--edit-deal-room-header": function(d) { return "Rename deal room"; },
  ...
  "dashboard--rename-modal--deal-room-input--placeholder": function(d) { return "Deal room name"; },
  ...
  "dashboard--cta--blank": function(d) { return "Blank presentation"; },
  ...
  "dashboard--cta--create-new-deal-room": function(d) { return "Create deal room"; },
  ...
  "dashboard--cta--description--start-from-blank": function(d) { return "Start from blank"; },
  "dashboard--cta--description--create-new-deal-room": function(d) { return "Everything for a deal in one place"; },
  ...
  "dashboard--continue-on-desktop": function(d) { return "To create, edit, and collaborate on presentations, head to the desktop app. Use the mobile apps to view and comment on decks on the go."; },
  ...
  "dashboard--home--hero--subtitle": function(d) { return "Everyone on your team can see and add presentations and folders here. Use your private folder if you’d like some privacy."; },
  ...
  "dashboard--folder--hero--subtitle": function(d) { return "Everyone on your team can see and add presentations to this folder. If you’d like some privacy, start working in your private folder instead."; },
  ...
  "dashboard--create-presentation-modal--starter-plan-info-message--cannot-create-private-presentations": function(d) { return "You can’t create a private presentation on the Free plan."; },
  "dashboard--create-presentation-modal--starter-plan-info-message--select-workspace-folder": function(d) { return "#[message] Select a team folder instead."; },
  ...
  "dashboard--trash--no-deleted-presentations--title": function(d) { return "No deleted presentations"; },
  "dashboard--trash--no-deleted-presentations--description": function(d) { return "Your presentations and templates will appear here after you or other team members delete them."; },
  "dashboard--deal-rooms--new": function(d) { return "New deal room"; },
  "dashboard--deal-rooms-card--subtitle": function(d) { return "Updated " + d.date; },
  ...
  "deal-room--link-copy--toast": function(d) { return "Link copied"; },
  "deal--room--editor--description-placeholder": function(d) { return "Greet your prospects and tell them why you're reaching out..."; },
  "deal-room--editor--add-link-label": function(d) { return "Add link or file"; },
  "deal-room--editor--contact-section-title": function(d) { return "Reach out"; },
  "deal-room--editor--select-presentation-input-placeholder": function(d) { return "Select one or more presentations to highlight"; },
  ...
  "editor--trash--info-message": function(d) { return "This presentation is deleted."; },
  "editor--trash--button-restore": function(d) { return "Restore"; },
  ...
  "editor--embed--paste-any-link--upsell-not-allowed": function(d) { return "Embed any link isn't included in the Free plan"; },
  ...
  "editor--media-picker--icons8-killswitch": function(d) { return "Icons8 search is currently unavailable. We're sorry for the inconvenience and are working hard to restore this service."; },
  ...
  "editor--variable-overview--overview-header-label": function(d) { return "Presentation information"; },
  "editor--variable-overview--overview-date-created": function(d) { return "Date created"; },
  "editor--variable-overview--overview-creator": function(d) { return "Creator"; },
  "editor--variable-overview--overview-status": function(d) { return "Status"; },
  ...
  "editor--variable-overview--new-value-placeholder": function(d) { return "Add content"; },
  ...
  "editor--variable-overview--empty-label": function(d) { return "Use variables to keep important content aligned throughout your deck."; },
  ...
  "editor--new-variable-modal--title": function(d) { return "Create variable"; },
  "editor--new-variable-modal--name": function(d) { return "Name"; },
  "editor--new-variable-modal--name-placeholder": function(d) { return "e.g. Date, Company name..."; },
  "editor--new-variable-modal--value": function(d) { return "Value"; },
  "editor--new-variable-modal--value-placeholder": function(d) { return "e.g. 2025, Spacework..."; },
  "editor--new-variable-modal--submit": function(d) { return "Save & insert"; },
  ...
  "editor--empty-variable-upsell--text-free": function(d) { return "Use variables to keep important content aligned throughout your deck"; },
  ...
  "inspector--variables--section-title": function(d) { return "Content"; },
  "inspector--variables--insert-button": function(d) { return "Insert variable"; },
  "inspector--variables--insert-button-hint": function(d) { return "#"; },
  ...
  "links-overview--empty-state--message": function(d) { return "Open a presentation and create a basic link, or #[link] to create analytics links and collect engagement data"; },
  ...
  "links-overview--limit-reached--title-upsell": function(d) { return "You have reached the limit of analytics links on your plan."; },
  "links-overview--limit-reached--subtitle-upsell": function(d) { return "To keep creating analytics links, either disable unused links or #[link]."; },
  "links-overview--limit-reached--subtitle-upsell-link": function(d) { return "upgrade your plan"; },
  "links-overview--upsell-banner--upgrade": function(d) { return "Upgrade to create analytics links"; },
  ...
  "links-overview--filters--link-budget": function(d) { return "Analytics links used: " + d.usage + " / " + d.quota; },
  "links-overview--filters--link-budget-tooltip": function(d) { return "This workspace has " + d.usage + " analytics links enabled out of " + d.quota + " available. Disabled links don’t count toward this total."; },
  "links-overview--filters--menu-section-header--admin": function(d) { return "Workspace owner visibility"; },
  "links-overview--filters--menu-section-header--link-type": function(d) { return "Link type"; },
  "links-overview--filters--non-private-or-shared-links": function(d) { return "All links"; },
  ...
  "links-overview--filters--advanced-links": function(d) { return "Analytics links"; },
  ...
  "links-overview--table--presentation-name-hover-tooltip": function(d) { return "Go to " + d.name; },
  "links-overview--table--presentation-folder-hover-tooltip": function(d) { return "Go to " + d.name; },
  ...
  "links-overview--table--header-cell--visits": function(d) { return "Visits"; },
  ...
  "links-list--icon-tooltip--basic": function(d) { return "Basic link"; },
  "links-list--icon-tooltip--basic-disabled": function(d) { return "Basic link, disabled"; },
  "links-list--icon-tooltip--advanced-disabled": function(d) { return "Analytics link, disabled"; },
  "links-list--icon-tooltip--advanced": function(d) { return "Analytics link"; },
  ...
  "links-share-modal--new-links-callout--title": function(d) { return "Discover new basic links"; },
  "links-share-modal--new-links-callout--info": function(d) { return "Unlike public access, basic links let you create multiple links per presentation. They’ll also show up on the new links overview page, where you can find links from all your team’s presentations."; },
  ...
  "link-visits--tooltip--message-basic-na": function(d) { return "No analytics"; },
  "link-visits--tooltip--view-data": function(d) { return "View data"; },
  "link-visits--tooltip--view-data--disabled": function(d) { return "View legacy data"; },
  "link-pill--disabled": function(d) { return "Disabled"; },
  "links--pill--advanced": function(d) { return "Analytics"; },
  "new-page-link--link-type-box--title--advanced": function(d) { return "Analytics link"; },
  "new-page-link--link-type-box--subtitle--advanced": function(d) { return "Tracks slide views, visit duration, and engagement, with optional passcode."; },
  "new-page-link--link-type-box--title--basic": function(d) { return "Basic link"; },
  "new-page-link--link-type-box--subtitle--basic": function(d) { return "Send your presentation to anyone. Comes without activity tracking or passcode."; },
  "new-link-page--callout": function(d) { return "The features below are only available on #[analytics-links:analytics links]."; },
  ...
  "live-collab--session-started-popover--description": function(d) { return plural(d.count, 0, en, { one: number(d.count, "count") + " teammate is", other: number(d.count, "count") + " of your teammates are" }) + " in a live session."; },
  ...
  "mobile--managed-links--link-type--analytics": function(d) { return "Analytics link"; },
  "mobile--managed-links--link-type--basic": function(d) { return "Basic link"; },
  ...
  "mobile--managed-links--link-type-desc--analytics": function(d) { return "Tracks slide views, visit duration, and engagement, with optional passcode."; },
  "mobile--managed-links--link-type-desc--basic": function(d) { return "Send your presentation to anyone. Comes without activity tracking or passcode."; },
  ...
  "mobile--links--analytics-links-info": function(d) { return "Analytics links aren't available when sharing from mobile."; },
  ...
  "platform--footer--company--community": function(d) { return "Community"; },
  ...
  "platform--deal-room--error-title": function(d) { return "We can’t display this deal room"; },
  "platform--deal-room--error-description": function(d) { return "It may have been closed. Try asking the person who owns it for help."; },
  ...
  "platform--deal-room--contact-title": function(d) { return "Reach out"; },
  "platform--deal-room--resources-title": function(d) { return "Resources"; },
  ...
  "folder-picker--label-workspace": function(d) { return "Team"; },
  ...
  "title-bar--folder-workspace": function(d) { return "Team"; },
  ...
  "workspace-settings--presentation-analytics-consent--title-ng": function(d) { return "Require visitor consent for engagement analytics on analytics links"; },
  ...
  "workspace-settings--presentation-analytics-consent--description-part-1": function(d) { return "When turned on, all analytics links with engagement analytics enabled will require visitors to consent to cookies. Visitors will see a cookie consent screen and may opt out."; },
  ...
  "workspace-settings--delete---modal--title": function(d) { return "Delete workspace?"; },
  "workspace-settings--delete---modal--text": function(d) { return "You and everyone else in this workspace will lose access to all content. This cannot be undone."; },
  "workspace-settings--delete---modal--input-label": function(d) { return "Enter the workspace name to proceed:"; },
  "workspace-settings--delete---modal--cancel-button": function(d) { return "Keep workspace"; },
  "workspace-settings--delete---modal--confirm-button": function(d) { return "Delete workspace permanently"; },
  ...
  "workspaces--revoke-guest-access-modal-description": function(d) { return "If you remove a guest they will lose access to these shared presentations. However, if another member of your team has privately shared a presentation with this guest, they will still have access to it."; },
