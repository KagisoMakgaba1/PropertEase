    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          PropertEase is the best platform to find
          your next perfect place to live.
          <br />
          We have a variety of properties you can choose from.
        </div>
      ...
      <Swiper navigation>
        {
          ...
          offerListings.map((listing) => (
            <SwiperSlide>
              ...
              center no-repeat`, backgroundSize:"cover"}} className='h-[500px]' key={listing._id}></div>
            </SwiperSlide>
        ))}
      </Swiper>
